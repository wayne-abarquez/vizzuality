	...
	<div class="span-24 raceContainer" id="race">
		...
		<div class="span-23 map" id="runnityHomeMap">
            <object id="flashMovie" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="930" height="364" wmode="opaque">
              <param name="movie" value="/flash/runnitHomeMap.swf?5" />
              <!--[if !IE]>-->
              <object type="application/x-shockwave-flash" data="/flash/runnitHomeMap.swf?5" width="930" height="364" wmode="opaque">
              <!--<![endif]-->
					...
					<div class="column span-8 last races">
						...
						<div class="column span-5 last">
							...
							<div class="raceDateDetails">
								...
								<p class="runnersNumber">{$race.distance_text} | {$race.num_users} van <img src="{if $race.inscrito eq "t"}/img/running_ico_yes.png{else}/img/running_ico_no.png{/if}" /></p>
							</div>
						</div>
					</div>	
				{/if}	
