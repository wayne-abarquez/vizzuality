package com.vizzuality
{
    ...
    public class Preloader extends DownloadProgressBar
    {
        ...
        */
        [Embed(source="assets/MainPreloader.swf", symbol="Preloader")]
        ...
        */
        ...
        {
            super();
            var whiteBox:Sprite = new Sprite();
            this.addChild(whiteBox);
            whiteBox.graphics.beginFill(0xFFFFFF,1);
            whiteBox.graphics.drawRect(-250,-250,500,500);
