package
{
	...
	public class HeatMapOverlay extends TileLayerOverlay
	{
		 ...
		 * @param height
		 */
		public function HeatMapOverlay(param:Object = null)
		{
			trace(w+"-"+h);
			super(param);
			addChild(bmp);
		...
		{
			w = Application.application.mapCanvas.width;
			h = Application.application.mapCanvas.height;
