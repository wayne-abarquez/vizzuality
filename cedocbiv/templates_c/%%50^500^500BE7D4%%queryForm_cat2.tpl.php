<?php /* Smarty version 2.6.26, created on 2009-11-30 10:53:15
         compiled from queryForm_cat2.tpl */ ?>
	  ...
	  <div class="instruction"> 
		<div> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><span class="search-1"> 
		  ...
		  <select name="genus">
			...
			<?php unset($this->_sections['genus']);
$this->_sections['genus']['name'] = 'genus';
$this->_sections['genus']['loop'] = is_array($_loop=$this->_tpl_vars['GenusResults']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['genus']['show'] = true;
$this->_sections['genus']['max'] = $this->_sections['genus']['loop'];
$this->_sections['genus']['step'] = 1;
$this->_sections['genus']['start'] = $this->_sections['genus']['step'] > 0 ? 0 : $this->_sections['genus']['loop']-1;
if ($this->_sections['genus']['show']) {
    $this->_sections['genus']['total'] = $this->_sections['genus']['loop'];
    if ($this->_sections['genus']['total'] == 0)
        $this->_sections['genus']['show'] = false;
} else
    $this->_sections['genus']['total'] = 0;
if ($this->_sections['genus']['show']):

            for ($this->_sections['genus']['index'] = $this->_sections['genus']['start'], $this->_sections['genus']['iteration'] = 1;
                 $this->_sections['genus']['iteration'] <= $this->_sections['genus']['total'];
                 $this->_sections['genus']['index'] += $this->_sections['genus']['step'], $this->_sections['genus']['iteration']++):
$this->_sections['genus']['rownum'] = $this->_sections['genus']['iteration'];
$this->_sections['genus']['index_prev'] = $this->_sections['genus']['index'] - $this->_sections['genus']['step'];
$this->_sections['genus']['index_next'] = $this->_sections['genus']['index'] + $this->_sections['genus']['step'];
$this->_sections['genus']['first']      = ($this->_sections['genus']['iteration'] == 1);
$this->_sections['genus']['last']       = ($this->_sections['genus']['iteration'] == $this->_sections['genus']['total']);
?>
