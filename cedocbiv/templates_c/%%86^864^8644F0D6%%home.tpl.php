<?php /* Smarty version 2.6.26, created on 2009-11-25 13:25:45
...
<div> 
  <div id="header"> 
	<h2 align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#CC0033" size="4"><b>Bases 
	  de Dades de l'Herbari BCN</b></font></h2>
  </div>
  <div class="news-summary" style="z-index: 1000;"> 
	<div class="news-body"> 
	  <p class="texto_intro"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Des 
	  ...
	  <p class="subheader"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">aprox. 
		...
		<?php echo $this->_tpl_vars['Numregistros']; ?>

		</b> registres | <b> 
		<?php echo $this->_tpl_vars['NumRegistrosImagen']; ?>

		</b> imatges | <b> 
		<?php echo $this->_tpl_vars['NumRegistrosGeoreferenciados']; ?>
	  ...
	  <p class="news-submitted">&nbsp;</p>
	</div>
  </div>
</div>
<tr> 
  <td colspan="7" valign="top" height="52">&nbsp; </td>
  <td></td>
</tr>
<!-- #EndEditable -->
		<hr>
