...
<div class="content">
	...
	<div class="news-body">
    	...
    	{if $hasGeo}
			<div class="MapResultTaxon" id="map"></div><a href="{$smarty.const.SERVER_URL}taxondetailKml.php?nameauthoryearstring={$smarty.request.nameauthoryearstring|urlencode}">Ver en Google Earth</a>
		{/if}
