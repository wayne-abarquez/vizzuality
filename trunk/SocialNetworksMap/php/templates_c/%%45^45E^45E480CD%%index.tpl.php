<?php /* Smarty version 2.6.22, created on 2009-03-05 20:03:18
...
<div id="wrap">
	...
	<div id="header"><div id="header-content">	
		...
		<h1 id="logo"><a href="index.html" title="">GROMS<span class="gray">v2.0</span></a></h1>	
		<h2 id="slogan">A joint collaboration of GBIF and UNEP/CMS</h2>		
		
		<!-- Menu Tabs -->
		<ul>
			<li><a href="#" id="current">Distributions</a></li>
			<li><a href="#">Bats</a></li>
			<li><a href="#">Literature</a></li>
			<li><a href="#">Flyaways</a></li>
			<li><a href="#">About</a></li>			
		</ul>			
		<input id="search" name="search" value="Search" type="text" size="30" />	
	</div></div>
	...
	<div id="content-wrap"><div id="content">		
		...
		<div id="main">		
			...
			<div class="post">
				...
				<p><strong>PixelGreen 1.2</strong> is a free, W3C-compliant, CSS-based website template 
