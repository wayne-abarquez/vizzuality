package com.vizzuality.tests
{
	...
	public class MarkersOverlaySearch3 extends OverlayBase
	{		
		...
		public function MarkersOverlaySearch3() {
			super();
		...
		public function addMarkerCluster(markers:Array,medPoint:LatLng):void {

	        data = new Data();	

	        for each(var m:SearchMarker2 in markers) {
				//create the anchor
				var baseAnchor:ClusterMarkerIcon = new ClusterMarkerIcon(medPoint);			
				//var baseAnchor:NodeSprite=data.addNode();
		        baseAnchor.fix(1);
		        var pos:Point = pane.fromLatLngToPaneCoords(medPoint);
		        baseAnchor.x=pos.x;
				baseAnchor.y=pos.y;
				data.addNode(baseAnchor);
				
		        var m2:SearchMarkerIcon=new SearchMarkerIcon(m.markerData); 
