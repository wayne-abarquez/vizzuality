...
var regions = [];
	...
	function addRegions() {
		...
		tilelayer.getTileUrl = function(xy,z) { return "http://184.73.201.235/geoserver/gwc/service/gmaps?layers=ppe:marine_public_blue&zoom="+z+"&x="+xy.x+"&y="+xy.y;};
		tilelayer.isPng = function() { return true;};
		tilelayer.getOpacity = function() { return 1.0; }

		var marineOverlay = new GTileLayerOverlay(tilelayer);
		map.addOverlay(marineOverlay);
