<?php /* Smarty version 2.6.26, created on 2009-10-13 13:54:47
	...
	<div id="header" class="span-24 column header">
		...
		<div class="span-19 last access">
			<p>
				...
				<a href="/perfil/<?php echo $_SESSION['user']['username']; ?>
">bienvenido <?php echo $_SESSION['user']['username']; ?>
</a>
				/ 
	...
	<div class="span-24 subHeader">
		...
		<?php endif; ?>
		<?php if ($this->_tpl_vars['section'] == 'usuario' || $this->_tpl_vars['section'] == 'registro' || $this->_tpl_vars['section'] == '404'): ?> 
			<div class="buttonmenuContainer">
