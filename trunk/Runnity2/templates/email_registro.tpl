...
<p>Ya puedes inscribirte a las carreras y activar tu alerta de proximidad por email. Sólo tienes que ir a tu página de usuario <a href="http://www.runnity.com/user/{$username}">http://www.runnity.com/user/{$username}</a>,hacer login y rellenar el formulario.</p>
